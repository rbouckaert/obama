 ...
 * *
 */
public class SingleComponentTreeLikelihoodTest  {

    public SingleComponentTreeLikelihoodTest() {
        super();
    }

    protected MixtureTreeLikelihood newTreeLikelihood() {
    	System.setProperty("java.only","true");
        return new MixtureTreeLikelihood();
    }
    ...
    public void testJC69Likelihood() throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "1.0", "component", JC);

        GenericTreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", MixtureSiteModel);
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(logP, -1992.2056440317247, BEASTTestCase.PRECISION);

        likelihood.initByName("useAmbiguities", true, "data", data, "tree", tree, "siteModel", MixtureSiteModel);
        logP = likelihood.calculateLogP();
        assertEquals(logP, -1992.2056440317247, BEASTTestCase.PRECISION);
    }
    ...
    public double[] testJC69Likelihood(Alignment data, Tree tree) throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "0.6", "component", JC);
        ...
        GenericTreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", MixtureSiteModel, "scaling", MixtureTreeLikelihood.Scaling.none);        
        double[] logP = new double[2];
        logP[0] = likelihood.calculateLogP();
        System.out.println(logP[0]);

        System.out.println("With tip likelihoods:");
        likelihood.initByName("useTipLikelihoods", true, "data", data, "tree", tree, "siteModel", MixtureSiteModel, "scaling", MixtureTreeLikelihood.Scaling.none);
    ...
    public void testAscertainedJC69Likelihood() throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "1.0", "component", hky);
    ...
    public void testK80Likelihood() throws Exception {
        ...
        MixtureTreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", MixtureSiteModel);
    ...
    public void testGTRLikelihood() throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "1.0", "component", gsm);
        ...
        likelihood.initByName("useAmbiguities", false, "data", data, "tree", tree, "siteModel", MixtureSiteModel);
        logP = likelihood.calculateLogP();
        assertEquals(logP, -1969.145839307625, BEASTTestCase.PRECISION);
    }
    ...
    void aminoacidModelTest(SubstitutionModel substModel, double expectedValue) throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "1.0", "component", substModel);
    ...
    public void testSDolloLikelihood() throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "1.0", "component", SDollo);

        MixtureTreeLikelihood likelihood = newTreeLikelihood();
        likelihood.initByName("data", data, "tree", tree, "siteModel", MixtureSiteModel);

        double logP = 0;
        likelihood.initByName("data", data, "tree", tree, "siteModel", MixtureSiteModel, "useAmbiguities", true);
        logP = likelihood.calculateLogP();
    ...
    public void testBinaryCovarionLikelihood() throws Exception {
        ...
        MixtureSiteModel MixtureSiteModel = new MixtureSiteModel();
        MixtureSiteModel.initByName("mutationRate", "1.0", "component", covarion);
